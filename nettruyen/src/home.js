function execute() {
    return Response.success([
        ...
        {title: "Theo dõi", input: "https://www.nettruyenin.com/tim-truyen?status=-1&sort=20", script: "gen.js"},
        {title: "Bình luận", input: "https://www.nettruyenin.com/tim-truyen?status=-1&sort=25", script: "gen.js"}
    ]);
}